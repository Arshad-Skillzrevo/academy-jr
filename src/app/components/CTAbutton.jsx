      ...
      {["Yes", "No"].map((opt) => (
        <button
          ...
          style={{
            ...
            cursor: "pointer",
            fontWeight: 700,
            background: value === opt ? VIOLET : "#fff",
            color: value === opt ? "#fff" : "#6b7280",
            borderColor: value === opt ? VIOLET : "#d1d5db",
          }}
        >
          {opt}
        </button>
...
function EnquiryModal({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://4606bd36-c5fd-4702-b793-059cd091a766.neodove.com/integration/custom/ce444e26-b24a-43d2-8d35-92499b03baef/leads", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(payload),
      });
        ...
        >
          ...
          <div
            style={{
              ...
              background: `linear-gradient(90deg,#0ea5e9,${VIOLET},#f97316)`,
            }}
          />
          ...
          <div style={{ padding: "20px 24px 28px" }}>
            ...
            {status === "success" ? (
              ...
              >
                ...
                <Field label="Do you have a Laptop or Desktop?">
                  <YesNoToggle
                ...
                >
                  <input
                    type="checkbox"
                    required
                    style={{ marginTop: 2, accentColor: VIOLET, flexShrink: 0 }}
                  />
                  <span style={{ fontSize: 12, color: "#6b7280" }}>
                    By submitting, you agree to our{" "}
                    <a href="/TermsandConditions" style={{ color: VIOLET }}>
                      Terms of Use
                    </a>{" "}
                    &amp;{" "}
                    <a href="/PrivacyPolicy" style={{ color: VIOLET }}>
                      Privacy Policy
                    </a>
                  </span>
                </label>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 12,
                    border: "none",
                    background: status === "sending" ? "#a78bfa" : VIOLET,
                    color: "#fff",
                    fontWeight: 700,
                    fontSize: 15,
                    cursor: status === "sending" ? "not-allowed" : "pointer",
...
/* ── CTA BUTTON (drop-in replacement) ── */
export function CTAButton({
  label,
  icon: Icon,
  className = "",
